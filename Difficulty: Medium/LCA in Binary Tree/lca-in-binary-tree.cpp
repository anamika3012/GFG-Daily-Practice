...
class Solution {
  public:
    ...
    Node* lca(Node* root, int n1, int n2) {
        ...
        //Left SubTree and Right SubTree Answers
        Node* leftAns = lca(root->left , n1 , n2);
        Node* rightAns = lca(root->right , n1 , n2);
        
        //Case 1 : When both left ans right SubTree return Null 
        if(leftAns == NULL && rightAns == NULL) return NULL;
        
        //Case 2 : When left SubTree returns Null and right SubTree returns non null value 
        if(leftAns == NULL && rightAns != NULL) return rightAns;
        
        //Case 3 : When left SubTree returns non Null value and right SubTree returns null value
        if(leftAns != NULL && rightAns == NULL) return leftAns;
        
        //Case 4 : When both left and right SubTree return non null value 
        else return root;
    }
};
